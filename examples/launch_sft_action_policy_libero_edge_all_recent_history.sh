...
# Formal E003 keeps the Local interface fixed at exactly one 32-D token.
...
# Formal E003 must not inherit another recipe or auto-resume namespace from
# the caller's shell. H32, if run, gets its own launcher/namespace.
export TOML_FILE="examples/toml/sft_config/action_policy_libero_edge_all_recent_history.toml"
export RUN_NAME="edge_libero_4in1_recent_history_h16"
